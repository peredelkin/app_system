...
typedef reg_u8_t tic12400_data_di_out_t;
typedef reg_u16_t tic12400_data_ai_out_t;
...
struct _S_Fake_Tic12400 {
    ...
    // Входные данные.
    // Выходные данные.
    tic12400_data_di_out_t out_di[TIC12400_DI_COUNT];
    tic12400_data_ai_out_t out_ai[TIC12400_AI_COUNT];
    // Параметры.
    // Регистры.
    // Методы.
    ...
    // Коллбэки.
    // Внутренние данные.
    tic12400_internal_data_t regs_data;
};
